    ...
    <footer id="contact" className="bg-black pt-16 pb-8">
      <div className="container mx-auto px-6 lg:px-24">
        ...
        <div className="mb-12">
          ...
          >
            <h2 className="text-white font-grifter text-4xl mb-2">SPANISHLINGO</h2>
            <h3 className="text-brand-red font-grifter text-8xl lg:text-[220px] leading-none tracking-wider">
              STUDIOS
            </h3>
                ...
                <ul className="space-y-4">
                  <li>
                    <button
                      ...
                      className="text-white font-aeonik uppercase hover:text-brand-red transition-colors"
                    >
                      Mixes
                    </button>
                  </li>
              ...
              <div className="lg:col-span-4">
                ...
                <form className="relative">
                  <input
                    type="email"
                    placeholder="Email"
                    className="w-full px-7 py-5 rounded-full border border-white bg-transparent text-white placeholder-white/60 font-aeonik text-sm uppercase focus:outline-none focus:ring-2 focus:ring-brand-red"
                  />
                  <button
                    type="submit"
        ...
        <div className="border-t border-white/30 pt-8">
          <div className="flex justify-center gap-4 mb-8">
            <a
              ...
              className="w-14 h-14 rounded-full border border-white flex items-center justify-center hover:bg-brand-red hover:border-brand-red transition-colors"
            >
          ...
          <div className="text-center">
            <p className="text-white font-aeonik font-bold uppercase text-sm">
