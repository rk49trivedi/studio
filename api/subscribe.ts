  ...
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #F5F5F5;">
    ...
    if (error instanceof Error) {
      ...
      if (errorStr.includes('invalid login') || 
        ...
        console.error('SMTP Authentication Error - Check your SMTP_USER and SMTP_PASSWORD in Vercel environment variables');
        ...
        console.error('SMTP Connection Error - Check your SMTP_HOST and SMTP_PORT in Vercel environment variables');
        ...
        console.error('SMTP Host Error - Check your SMTP_HOST in Vercel environment variables');
      }
    }
